...
.its_my_app_work #tab5 #farben-tab-vsg.option-grid,
.its_my_app_work #tab5 .option-grid.tab5-vsg-grid {
    display: grid !important;
...
.its_my_app_work #tab5 #farben-tab-vsg .card-option.vsg-option-card,
.its_my_app_work #tab5 .option-grid.tab5-vsg-grid .card-option.vsg-option-card {
    box-sizing: border-box !important;
...
.its_my_app_work #tab5 #farben-tab-vsg .vsg-option-title,
.its_my_app_work #tab5 .option-grid.tab5-vsg-grid .vsg-option-title {
    margin: 0 !important;
}

.its_my_app_work #tab5 #farben-tab-vsg .vsg-option-title strong,
.its_my_app_work #tab5 .option-grid.tab5-vsg-grid .vsg-option-title strong {
    display: block !important;
    font-size: 13px !important;
    line-height: 1.25 !important;
    font-weight: 700 !important;
...
.its_my_app_work #tab5 #farben-tab-vsg .card-option.vsg-option-card > img,
.its_my_app_work #tab5 .option-grid.tab5-vsg-grid .card-option.vsg-option-card > img {
...
.its_my_app_work #tab5 .option-grid.tab5-vsg-grid .card-option.vsg-option-card .checkmark-box img {
